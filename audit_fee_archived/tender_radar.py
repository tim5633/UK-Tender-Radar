...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--history-csv", default=str(root / "tender_history.csv"), help="Detailed output CSV")
    p.add_argument("--shortlist-csv", default=str(root / "tender_shortlist.csv"), help="Priority shortlist CSV")
